                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    Assign teachers to teach this subject to specific sections. Each section can have one teacher.
                                </div>
                                    ...
                                    <table class="table table-bordered" id="assignmentsTable">
                                        ...
                                        <tbody id="assignmentsBody">
                                            <tr id="rowTemplate" style="display: none;">
                                                ...
                                                <td>
                                                    <select name="assignments[0][status]" class="form-control">
...
<script>
    ...
    $(document).ready(function() {
        // Initialize Select2 for initial selects if any
        $('.section-select, .teacher-select').select2({
            theme: "bootstrap-5",
            width: '100%'
        });
    });
    ...
    $('#addAssignmentRow').click(function() {
        ...
        // Update name attributes with counter
        template.find('select[name="assignments[0][section_id]"]').attr('name', `assignments[${rowCounter}][section_id]`);
        template.find('select[name="assignments[0][teacher_id]"]').attr('name', `assignments[${rowCounter}][teacher_id]`);
        template.find('select[name="assignments[0][status]"]').attr('name', `assignments[${rowCounter}][status]`);
        
        // Re-initialize Select2 on the new selects
        template.find('.section-select, .teacher-select').each(function() {
        ...
        $('#assignmentsBody').append(template);
    });

    // Remove row
    $(document).on('click', '.remove-row', function() {
        if ($('#assignmentsBody tr').length > 1) {
